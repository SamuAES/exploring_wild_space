...
def assign_section_from_wall(bird_x, bird_y, wall_x, wall_y1, wall_y2):
    """
    Assign the section of the cage where the bird is located based on its coordinates and
    the middle wall coordinates.
    ...
    wall_x : float
        Middle x-coordinate of the wall.
    wall_y : float
        Middle y-coordinates of the wall.
    Returns
    -------
    dict
        Dictionary with the section of the cage where the bird is located.
    ...
    # Calculate the middle lower and upper y-coordinates of the perch
    # 2/7 wall length -> top
    # 3/7 wall length -> middle
    # 2/7 wall length -> top
    middle_upper_y = wall_y1 + (wall_y2 - wall_y1) * (2/7)
    middle_lower_y = wall_y1 + (wall_y2 - wall_y1) * (5/7)
